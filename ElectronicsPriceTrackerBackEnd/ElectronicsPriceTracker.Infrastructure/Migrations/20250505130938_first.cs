        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Listings_Platforms_PlatformId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_SecondHandListings", x => x.Id);
                    table.ForeignKey(
                        name: "FK_SecondHandListings_Platforms_PlatformId",
                        column: x => x.PlatformId,
                        principalTable: "Platforms",
                        principalColumn: "PlatformId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_SecondHandListings_Products_ProductId",
                        column: x => x.ProductId,
                        principalTable: "Products",
                        principalColumn: "ProductId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_SecondHandListings_PlatformId",
                table: "SecondHandListings",
                column: "PlatformId");

            migrationBuilder.CreateIndex(
                name: "IX_SecondHandListings_ProductId",
                table: "SecondHandListings",
                column: "ProductId");
